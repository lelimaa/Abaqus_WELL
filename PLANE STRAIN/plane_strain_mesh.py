...
# class CasingPart:
    ...
    #     m = mdb.models[modelName]
    #     sketch_name = '__profile__' + self.name
    #     s = m.ConstrainedSketch(name=sketch_name, sheetSize=500.0)
    #     s.setPrimaryObject(option=STANDALONE)
...
if __name__ == "__main__":
    ...
    obj_a = AnnulusPart("AnnulusPart1",
                     data={"center1": [0,0],
                           "center2": [0,0],
                           "outer_radius": 10,
                           "thickness": 2},)
    obj_a.create_part("MyFirstModel")
    obj_a.create_base_sets("MyFirstModel")
    obj_a.add_to_assembly("MyFirstModel")

    obj_r = RockPart("RockPart1",
                     data={"center1": [0,0],
                           "center2": [0,0],
                           "outer_radius": 100,
                           "thickness": 90},)
    obj_r.create_part("MyFirstModel")
    obj_r.create_base_sets("MyFirstModel")
    obj_r.add_to_assembly("MyFirstModel")