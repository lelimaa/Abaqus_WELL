...
def CasingStresses(data, name_phase, density_steel, density_cement, z_top, z_bottom):
    ...
    force_real_bottom = pressure_inner_casing * area_inner - pressure_outer_casing * area_outer  # Net force at the base of the casing due to the fluid pressures

    stress_bottom = force_real_bottom / area_s

    force_real_top = force_real_bottom + density_steel * gravity * area_s * (height_base_casing - height_water_above_casing)  # Net force at the top of the casing considering the weight of the steel material

    stress_top = force_real_top / area_s
